...
function KimsDragon() {
    return (
        <>
            ...
            <ContentsNav links={contentsLinks} skipTargetId="kims-dragon-content" />

            <main id="kims-dragon-content" className="case-study-page" aria-label="Case Study Main Content">
                <section id="overview" className="container-fluid study-section" aria-label="Case Study Overview">
                    ...
                    >
                        ...
                        <article>
                            <p>
                                This project is an interaction design and development project to create a mobile
                                ordering web application for a local food truck on the Drexel University campus. It was
                                created for the class IDM 216, Interaction Design II, under the direction of Professor
                                Jervis Thompson. Working on a team of 5 UXID students, we were tasked with delegating
                                roles in project management, design, development, and data architecture to complete our
                                web app for Kim&apos;s Dragon. Over 10 a week period we transformed early-stage designs
                                into a fully functional web application. Through multiple iterations informed by
                                usability testing, we refined the user interface and backend functionality to create a
                                seamless and efficient ordering system. My role as primary developer and secondary data
                                architect involved front-end implementation, database structuring, and PHP integration
                                to support dynamic menu browsing and order processing.
                            </p>
                        </article>
                    </article>
                </section>
                ...
                >
                    ...
                    <article className="case-study-sect color-tan" aria-label="Project Background Subsection">
                        ...
                        <p>
                            ...
                            Street referred to as &ldquo;Food Truck Alley.&rdquo; Working from designs created in IDM
                            215, Interaction Design I, the specific focus of this project was to develop a mobile
                            ordering web application for the truck. Over the span of 10 weeks, I served as the primary
                            developer and secondary data architect, working alongside my teammates to bring our
                            application from concept to completion. The project operated within the constraints of
                            academic guidelines, requiring the use of HTML, CSS, JavaScript, and PHP to create and
                            execute a full production pipeline resulting in a fully functioning web app.
                        </p>
                    </article>
                    ...
                    <article className="case-study-sect color-tan" aria-label="Goals and Objectives Subsection">
                        ...
                        <p>
                            With these objectives in mind, our team followed a structured development process to deliver
                            a functional, accessible, and efficient mobile ordering platform.
                        </p>
                    </article>
                </section>
                ...
                <section id="roles" className="container-fluid study-section" aria-label="Roles">
                    ...
                    <p>
                        For this project I was on a team with 5 members. We each had primary, secondary, or tertiary
                        roles in project management, design, development, and data architecture. We presented these
                        roles on our team project page.
                    </p>
                    <img
                        className="img-fluid"
                        src={team}
                ...
                <section id="users" className="container-fluid study-section" aria-label="Users and Audience">
                    ...
                    <p>
                        To begin the project, we referred to materials gathered in IDM 216, Interaction Design I, where
                        the preliminary designs for this project were developed. Pulling from that data we modified our
                        user persona and journey map to align with our goals for the development of the project. We
                        compiled this information onto a team project page.
                    </p>
                ...
                >
                    ...
                    <article className="case-study-sect color-tan" aria-label="Style Guide Subsection">
                        <h3>STYLE GUIDE</h3>
                        <p>
                            Pulling from the original designs created in IDM 216, Interaction Design I, we developed a
                            style guide to explore the site color scheme, fonts, and branding. As a developer I used
                            this guide to style the color schemes, typography, and reusable components in the CSS.
                            Having a consistent branding plan and all my assets in one place helped streamline the
                            front-end development process.
                        </p>
                        <img
                            className="img-fluid bg-tan"
                            src={styleGuide}
                    ...
                    <article className="case-study-sect color-tan" aria-label="Database Structures Subsection">
                        ...
                        >
                            <h3 className="btn-text color-accent-blue">Database Dump</h3>
                        </button>
                        <img
                            className="img-fluid"
                            src={database}
                    ...
                    <article className="case-study-sect color-tan" aria-label="Alpha Version Subsection">
                        ...
                        <p>
                            ...
                            usability testing. To begin the development process we first coded all the critical path
                            pages in HTML and CSS. We used one menu item as a template to help plan the structure and
                            ensure my media queries for responsive designs worked as intended. The only database
                            integration in the alpha was used to populate the menu items on main.php. This version of
                            the project was considered our Alpha, which included final images, CSS stylized Buttons,
                            Menus, Forms, and Navigation between all pages.
                        </p>
                        <img
                            className="img-fluid"
                            src={alpha}
                    ...
                    <article className="case-study-sect color-tan" aria-label="Beta Version Subsection">
                        ...
                        <p>
                            ...
                            develop more features. For the Beta, we began to incorporate PHP into the HTML and CSS
                            template pages to allow for database integration. This allows users to select items from the
                            menu, see the item details, and add items to the cart. In the cart, the subtotal, taxes, and
                            total are dynamically calculated. After checking out the user receives a receipt with a
                            prominent order number. Finally, we integrated microinteractions created by our secondary
                            developer across the PHP pages.
                        </p>
                        <img
                            className="img-fluid"
                            src={beta}
                ...
                <section id="results" className="container-fluid study-section" aria-label="Results">
                    ...
                    <p>
                        Following the final round of testing we incorporated some minor changes into the final build,
                        but overall the functionality worked as intended and only needed minor improvements. We
                        incorporated additional features like diet filters in the menu and customization options on each
                        menu item. We also went in and fixed minor PHP oversights like the ability to checkout without
                        any items in the cart and the ability to checkout without selecting a payment method. The final
                        completed site allows dynamic menu browsing, displaying recipes with their accompanying images
                        and information from the database. A user can add items to their cart and checkout. The
                        application as a whole adapts to mobile screen sizes, and is best viewed on a mobile device or
                        desktop phone simulator.
                    </p>
                    <p>
                        The final iteration of the Kim&apos;s Dragon mobile ordering web app successfully met its
                        objectives, providing a fully functional prototype that allowed users to browse menu items,
                        apply dietary filters, customize orders, and complete transactions with a streamlined checkout
                        process. Usability testing validated the effectiveness of our design, leading to minor
                        refinements such as error handling for empty carts and required payment selections. The project
                        not only improved the food truck&apos;s potential customer engagement but also demonstrated the
                        viability of a scalable, real-world solution for small food businesses. The application adapts
                        across mobile devices, ensuring accessibility for a wide range of users.
                    </p>
                    <img
                        className="img-fluid"
                        src={kimsCover}
