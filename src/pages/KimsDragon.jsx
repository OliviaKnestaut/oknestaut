...
const headerButtons = [
    { label: 'Hi-Fi Designs', url: 'https://www.figma.com/design/aoznyxHy1f4gIs1dlGbXYb/216-Project?node-id=793-904&t=kchccyAVZvLv7dOE-1' },
    ...
    return (
        <>
            ...
            <main id="kims-dragon-content" className="case-study-page" aria-label="Case Study Main Content">
                ...
                <section id="context-challenge" className="container-fluid study-section bg-accent-red inverted" aria-label="Context and Challenge">
                    ...
                    <article className="case-study-sect color-tan" aria-label="Project Background Subsection">
                        ...
                        <p>
                            Kim&apos;s Dragon is a beloved Asian cuisine food truck located on Drexel University&apos;s campus. A favorite of students and local residents alike, it is found on a section of Ludlow Street referred to as &ldquo;Food Truck Alley.&rdquo; Working from designs created in IDM 215, Interaction Design I, the specific focus of this project was to develop a mobile ordering web application for the truck. Over the span of 10 weeks, I served as the primary developer and secondary data architect, working alongside my teammates to bring our application from concept to completion. The project operated within the constraints of academic guidelines, requiring the use of HTML, CSS, JavaScript, and PHP to create and execute a full production pipeline resulting in a fully functioning web app.
                        </p>
                    </article>
                ...
                <section id="roles" className="container-fluid study-section" aria-label="Roles">
                    ...
                    <button type="button" className="btn btn-primary mx-auto d-block color-accent-blue bg-accent-blue color-accent-blue-hover" onClick={() => window.open('https://digmstudents.westphal.drexel.edu/~ojk25/idm216/', '_blank')}>
                    ...
                    <img className="img-fluid" src={team} alt="The Kim's Dragon Webapp team: Olivia Knestaut, Doyeon Yoo, Amy Au, Vy Le, and Hannah Desmond" />
                </section>
                ...
                <section id="users" className="container-fluid study-section" aria-label="Users and Audience">
                    ...
                    <button type="button" className="btn btn-primary mx-auto d-block color-accent-blue bg-accent-blue color-accent-blue-hover" onClick={() => window.open('https://digmstudents.westphal.drexel.edu/~ojk25/idm216/project-page.php', '_blank')}>
                    ...
                    <img className="img-fluid" src={userPersona} alt="User Persona for Madeline James, an 18-year-old college student who is a frequent customer of Kim's Dragon. She values convenience, efficency, and accessibility in her food ordering experience." />
                    <h3 className="color-accent-blue">JOURNEY MAP</h3>
                    <img className="img-fluid" src={journeyMap} alt="Journey Map for Madeline James, an 18-year-old college student who is a frequent customer of Kim's Dragon." />
                </section>

                <section id="process" className="container-fluid study-section bg-accent-red inverted" aria-label="Process and Insight">
                    ...
                    <article className="case-study-sect color-tan" aria-label="Style Guide Subsection">
                        ...
                        <img className="img-fluid bg-tan" src={styleGuide} alt="Style Guide for Kim's Dragon, outlining the color scheme, fonts, and branding elements for the mobile ordering web application." />
                    </article>
                    <article className="case-study-sect color-tan" aria-label="Database Structures Subsection">
                        ...
                        <button type="button" className="btn btn-primary mx-auto d-block color-accent-blue bg-tan color-accent-blue-hover" onClick={() => window.open('https://digmstudents.westphal.drexel.edu/~ojk25/idm216/database-dump.php', '_blank')}>
                            <h3 className="btn-text color-accent-blue">Database Dump</h3>
                        </button>
                        <img className="img-fluid" src={database} alt="Database Structures for Kim's Dragon, outlining the schema and relationships for the MySQL database." />
                    </article>
                    <article className="case-study-sect color-tan" aria-label="Alpha Version Subsection">
                        ...
                        <img className="img-fluid" src={alpha} alt="Alpha Version for Kim's Dragon, showcasing the initial development build with basic functionality and design elements." />
                    </article>
                    <article className="case-study-sect color-tan" aria-label="Beta Version Subsection">
                        ...
                        <img className="img-fluid" src={beta} alt="Beta Version for Kim's Dragon, showcasing the improved development build with enhanced functionality and design elements." />
                    </article>
                </section>
                ...
                <section id="results" className="container-fluid study-section" aria-label="Results">
                    ...
                    <article className="button-flex" aria-label="Final Result Buttons">
                        <button type="button" className="btn btn-primary d-block color-accent-blue bg-accent-blue color-accent-blue-hover" onClick={() => window.open('https://digmstudents.westphal.drexel.edu/~ojk25/idm216/final/', '_blank')}>
                            <h3 className="btn-text color-tan">Final Build</h3>
                        </button>
                        <button type="button" className="btn btn-primary d-block color-accent-blue bg-accent-blue color-accent-blue-hover" onClick={() => window.open('https://github.com/OliviaKnestaut/2501-idm216-blueprints', '_blank')}>
                            <h3 className="btn-text color-tan">Project Github</h3>
                        </button>
                    </article>
                    <p>
                        Following the final round of testing we incorporated some minor changes into the final build, but overall the functionality worked as intended and only needed minor improvements. We incorporated additional features like diet filters in the menu and customization options on each menu item. We also went in and fixed minor PHP oversights like the ability to checkout without any items in the cart and the ability to checkout without selecting a payment method. The final completed site allows dynamic menu browsing, displaying recipes with their accompanying images and information from the database. A user can add items to their cart and checkout. The application as a whole adapts to mobile screen sizes, and is best viewed on a mobile device or desktop phone simulator.
                    </p>
                    <p>
                    ...
                    <img className="img-fluid" src={kimsCover} alt="Three mobile screens showing pages from the Kim's Dragon Mobile Ordering Webapp" />
                </section>
            </main>
        </>
    );
