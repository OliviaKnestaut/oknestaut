...
const skills = [
    { category: 'Design & Media', items: 'Figma, Illustrator, Photoshop, InDesign, Premiere Pro, After Effects, Audition, Wireframing, High Fidelity Mockups, Photography' },
    { category: 'Programming', items: 'HTML, CSS, JavaScript, TypeScript, React, Node.js, Python, Java, PHP, Database Structures, GraphQL, GitHub, Linux, AWS, Azure' },
    { category: 'UX Research', items: 'User Interviews, Survey Testing, Statistical Analysis, Prototyping, Play-Testing, Usability Testing' }
];
    ...
    return (
        <main aria-label="Resume Main Content">
            ...
            <section className="resume-section d-flex row justify-content-center" aria-label="Resume Objective Section">
                ...
                <p>Detail-oriented developer and designer committed to creating meaningful and accessible digital experiences. Seeking to combine hands-on design experience, research skills, and technical expertise to deliver impactful technology solutions.</p>
            </section>
            ...
            <section className="resume-section d-flex row" aria-label="Education Section">
                ...
                <article aria-label="Drexel Education Information">
                    <h6><b>Drexel University,</b> Philadelphia, PA — <i>Bachelor of Science</i></h6>
                    <p>Sept 2022 — Present, <i>Expected Graduation June 2027</i></p>
                    <ul>
            ...
            <section className="resume-section d-flex row" aria-label="Work Experience Section">
                ...
                {workExperience.map((job) => (
                    <article key={job.company} aria-label={`${job.company} Work Experience Information`}>
                        <h6><b>{job.title}</b><i> {job.company}</i></h6>
            ...
            <section className="resume-section d-flex row" aria-label="Leadership Section">
                ...
                <article aria-label="Campus Activities Board Leadership Information">
                    <h6><b>President —</b><i> Drexel University Campus Activities Board</i></h6>
                    <p>June 2024 — Present,<i> Philadelphia, PA</i></p>
                    <ul>
                        <li>Facilitate communication between CAB, Drexel&apos;s primary event programming organization, and the University to ensure compliance with university policies, schedule on and off-campus events, and promote campus community</li>
                        <li>Coordinate strategic planning of 70+ events across 4 committees each year that engage over 7,000 Drexel undergraduate students</li>
                    </ul>
                </article>
            </section>

            <section className="resume-section skills-section d-flex row justify-content-center" aria-label="Skills Section">
            ...
            <section className="resume-section" aria-label="Awards Section">
                ...
                {awards.map((award) => (
                    <h6 key={award}><b>{award.split(' | ')[0]} |</b> {award.split(' | ')[1]}</h6>
                ))}
            </section>
        </main>
    );
