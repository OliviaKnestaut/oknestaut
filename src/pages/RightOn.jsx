        ...
        >
            <section id="overview" className="container-fluid study-section" aria-label="Case Study Overview">
                ...
                <article className="container-fluid study-section overview" aria-label="Case Study Overview Content">
                    ...
                    <article>
                        <p>
                            RightOn!™ is a web-based platform that engages students in thinking about and learning from
                            mistakes and misconceptions in K-12 math. By shifting focus from quick recall to
                            understanding why wrong answers are wrong, students see errors as learning opportunities,
                            gain confidence in their ability to improve, and develop deeper conceptual understanding of
                            core math concepts. The RightOn! platform consists of three parts: a learner-facing web app,
                            a database of games and questions, and a teacher facing dashboard.
                        </p>
                        <p>
                            Over the course of six months from April to September 2024 I completed a Co-Op Experience as
                            a User Experience Designer and Researcher at RightOn! education. Under the direction of CEO{' '}
                            <a
                            ...
                            <a
                                ...
                                rel="noopener noreferrer"
                                onClick={(event) =>
                                    openTrackedLink(event, 'https://www.linkedin.com/in/rodhinn/', 'Rod Hinn LinkedIn')
                                }
                            >
                                Rod Hinn
                            </a>{' '}
                            I spearheaded the comprehensive redesign of RightOn! Central, the teacher facing database of
                            games and questions. Fellow UX intern{' '}
                            <a
            ...
            <section id="problem" className="container-fluid study-section" aria-label="Case Study Problem Statement">
                ...
                <p>
                    The RightOn Education platform is still in beta and most design and development efforts have focused
                    on student gameplay (RightOn Play) and the in-game teacher dashboard (RightOn Host). The RightOn
                    Central website,{' '}
                    <a
            ...
            <section id="users" className="container-fluid study-section" aria-label="Case Study Users and Audience">
                ...
                <p>
                    The RightOn platform is acquired by teachers and school administrators for use in their classrooms
                    and school districts. RightOn prioritizes educational equity, offering the platform to all users for
                    free, without requiring any software downloads or student logins.{' '}
                    <b>
                        RightOn aims to be optimized for young and new-to-subject teachers to help familiarize them with
                        common core standards and reduce teacher turnover rates in math. Young and new-to subject
                        teachers, while often tech savvy, predominantly come from non-STEM majors and are more likely to
                        need pedagogical support. These teachers are also less traditional in their teaching methods and
                        more open to teaching social-emotional learning (SEL) and self-reflection.
                    </b>
                </p>
                <p>
            ...
            >
                ...
                <p className="research-intro color-tan">
                    ...
                    members to help develop the base of research surrounding the company's core tenants. These tenants
                    include a positive classroom culture of error, a sense of belonging in math spaces, and the power of
                    learning from mistakes. Research was conducted though literature reviews, play testing, and
                    competitive analysis. The following research findings were used to inform the design of RightOn
                    Central.
                </p>
            ...
            >
                ...
                <article className="case-study-sect" aria-label="Style Guide Section">
                    ...
                    <p>
                        ...
                        past app design that had been scrapped. In order to begin the comprehensive overhaul of Right On
                        Central we needed to ensure there would be a cohesive brand style across all three platforms in
                        the RightOn system. RightOn Play, the student facing game, was predominantly decorative-purple
                        and RightOn Host, the teacher dashboard, was predominantly secondary-accent. We decided to
                        incorporate both of these color schemes into RightOn Central as it is the database that bring
                        together Host and Play. All color combinations were tested for compliance with AA and AAA
                ...
                <article className="case-study-sect" aria-label="Responsive Design Section">
                    ...
                    <p>
                        It is essential that all systems in the RightOn platform are responsive and accessible on all
                        devices to align with the principle of Educational Equity. Not every school, district, or
                        program has access to laptops and technology funding so a mobile-friendly system can support a
                        greater range of classrooms. Design changes on different device sizes must allow all content to
                        remain accessible, allowing seamless performance without a detriment to user experience.
                    </p>
                    <img
                        className="img-fluid"
                        src={rightOnCover}
                ...
                <article className="case-study-sect" aria-label="Wireframes Section">
                    ...
                    <p>
                        ...
                        ideation from a previous UX team member to be used as a starting point. Beginning with digital
                        sketches, then moving to Figma wireframes I developed designs for the current and intended
                        functionality of RightOn Central, incorporating the system's card structure. These wireframes
                        were arranged into a wireflow to visualize possible use cases.
                    </p>
                    <button
                        type="button"
                ...
                <article className="case-study-sect" aria-label="High Fidelity Mockups Section">
                    ...
                    <p>
                        Once our ideas were solidified in wireframes, we began the process of transitioning them into
                        higher-fidelity mockups. These mockups included a wider scope of screens and interactions. These
                        designs were annotated in depth to ensure a clear understanding for future designers and
                        developers on the RightOn team. Specific designs and rationale will be elaborated below in the
                        results section.
                    </p>
                    <button
                        type="button"
                ...
                <article className="case-study-sect" aria-label="Design-Dev Handoff Section">
                    ...
                    <p>
                        As designs for screens, interactions, and components were completed the UX team periodically met
                        with the Dev team to discuss feasibility, make adjustments, and discuss rationale. These handoff
                        meetings often dove deep into pixel-perfect details, lasting for hours. Some designs, like
                        choosing common core standards or logging in/signing up, needed to be broken out into more
                        complex user flows. These flows were intended to provide more clarity to the dev team in the
                        implementation of processes with many steps.
                    </p>
                </article>
            </section>
            ...
            >
                ...
                <article className="case-study-sect color-tan" aria-label="Navigation Results Section">
                    ...
                    <p>
                        ...
                        These are the most present icons in the system, appearing on every page so they need to be clear
                        and engaging.
                    </p>
                ...
                <article className="case-study-sect color-tan" aria-label="Search and Filter Results Section">
                    ...
                    <p>
                        The search and filter functionality witin RightOn Central is designed to aid teachers in finding
                        relevant games. There is no search button, results begin lazy loading after a user begins
                        typing. The debounce for this lazy load is 800ms. The search bar parses the title, description,
                        and CCSS fields of all public games in the database. On the left side, users can filter results
                        by grade level. This filter allows multi-select so users can pick a range of applicable grades.
                        On the right side, users can sort results after a search. Only one sort option can be selected
                        at a time. Attempting to select another overrides the prior selection. The default sort on load
                        is date updated, descending (most recent at top). Other sort options are:
                    </p>
                ...
                >
                    ...
                    <p>
                        ...
                        Central&apos;s navigation. If a user is logged in the system will recommend games based on their
                        history, if a user is not logged in they will instead see featured games. All games in Explore
                        Games and Explore Questions are public games created by other members of the platform. Users can
                        access games they have created in My Library. User-owned games are sorted into public, private,
                        and drafts. Users can also find public games they have favorited here.
                    </p>
                    <figure aria-label="Explore Games Figure">
                        <figcaption>
                            <b>Explore Games</b>
                ...
                >
                    ...
                    <p>
                        ...
                        details. Viewing a game or question allows you to see the questions, correct answer, incorrect
                        answers, and incorrect answer explanations. This is also where users can launch a game to play
                        with their class.
                    </p>
                    <figure aria-label="View Game Figure">
                        <figcaption>
                ...
                <article className="case-study-sect color-tan" aria-label="Create Question Results Section">
                    ...
                    <p>
                        One of the most important flows within RightOn Central is the question creation flow. This flow
                        is used to create questions within a game and within the question bank. The user is guided
                        through the flow by secondary-accent highlights around the card next in the process.
                    </p>
                    <ResponsivePicture
                    ...
                    />
                    <p>
                        One feature of the RightOn system is the Wrong Answer Explanations Prototype. This program takes
                        in a math question and its multiple-choice options and uses AI to provide possible explanations
                        for the incorrect options. I integrated this functionality directly into the question-creation
                        flow to improve the ease of use.
                    </p>
