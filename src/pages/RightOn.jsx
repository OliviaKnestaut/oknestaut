            ...
            <main id="righton-content" className="case-study-page" aria-label="Case Study Main Content">
                <section id="overview" className="container-fluid study-section" aria-label="Case Study Overview">
                    ...
                    <article className="container-fluid study-section overview" aria-label="Case Study Overview Content">
                        ...
                        <article>
                            <p>
                                RightOn!™ is a web-based platform that engages students in thinking about and learning from mistakes and misconceptions in K-12 math. By shifting focus from quick recall to understanding why wrong answers are wrong, students see errors as learning opportunities, gain confidence in their ability to improve, and develop deeper conceptual understanding of core math concepts. The RightOn! platform consists of three parts: a learner-facing web app, a database of games and questions, and a teacher facing dashboard.
                            </p>
                            <p>
                                Over the course of six months from April to September 2024 I completed a Co-Op Experience as a User Experience Designer and Researcher at RightOn! education. Under the direction of CEO <a href="https://www.linkedin.com/in/sinclairwu/" target="_blank" rel="noopener noreferrer">Sinclair Wu</a>, Development Head <a href="https://www.linkedin.com/in/drewjhart/" target="_blank" rel="noopener noreferrer">Drew Hart</a>, and Design Head <a href="https://www.linkedin.com/in/rodhinn/" target="_blank" rel="noopener noreferrer">Rod Hinn</a> I spearheaded the comprehensive redesign of RightOn! Central, the teacher facing database of games and questions. Fellow UX intern <a href="https://www.linkedin.com/in/zachary-spindel-192307231/" target="_blank" rel="noopener noreferrer">Zach Spindel</a> assisted in the development of microinteraction design on this project, and Development Intern <a href="https://www.linkedin.com/in/kelly-couvrette/" target="_blank" rel="noopener noreferrer">Kelly Couvrette</a> assisted in early implementation.
                            </p>
                        </article>
                    </article>
                </section>

                <section id="problem" className="container-fluid study-section" aria-label="Case Study Problem Statement">
                    <h2 className="color-accent-purple">PROBLEM STATEMENT</h2>
                    <p>
                        The RightOn Education platform is still in beta and most design and development efforts have focused on student gameplay (RightOn Play) and the in-game teacher dashboard (RightOn Host). The RightOn Central website, <a href="https://central.rightoneducation.com/">https://central.rightoneducation.com/</a>, in its present state was created to get the platform up and running, rather than focus on user experience or design. In addition to being utilitarian the current designs are not responsive on small screen sizes. With RightOn Play and RightOn Host now sufficently developed and deployed in beta, the next focus was to redesign and restructure RightOn Central for an improved instructor experience choosing and creating games.
                    </p>
                    <figure aria-label="Explore Games Figure">
                        <figcaption className="color-accent-blue"><b>Explore Games</b></figcaption>
                        <img className="pc-img" src={currentCentralHome} alt="Explore Games Old Screen on PC and Mobile" />
                    </figure>
                    <figure aria-label="View Game Figure">
                        <figcaption className="color-accent-blue"><b>View Game</b></figcaption>
                    ...
                    <figure aria-label="Create Question Figure">
                        <figcaption className="color-accent-blue"><b>Create Question</b></figcaption>
                        <img className="pc-img" src={currentCreateQuestion} alt="Create Question Old Screen on PC and Mobile" />
                    </figure>
                </section>

                <section id="users" className="container-fluid study-section" aria-label="Case Study Users and Audience">
                    <h2 className="color-accent-purple">USERS &amp; AUDIENCE</h2>
                    <p>
                        The RightOn platform is acquired by teachers and school administrators for use in their classrooms and school districts. RightOn prioritizes educational equity, offering the platform to all users for free, without requiring any software downloads or student logins. <b>RightOn aims to be optimized for young and new-to-subject teachers to help familiarize them with common core standards and reduce teacher turnover rates in math. Young and new-to subject teachers, while often tech savvy, predominantly come from non-STEM majors and are more likely to need pedagogical support. These teachers are also less traditional in their teaching methods and more open to teaching social-emotional learning (SEL) and self-reflection.</b>
                    </p>
                    <p>
                    ...
                    <img className="img-fluid" src={classroomTesting} alt="Olivia in a Philadelphia classroom doing in person user testing with students" />
                </section>

                <section id="research" className="container-fluid study-section bg-accent-purple inverted" aria-label="Case Study Research">
                    <h2 className="color-tan">RESEARCH</h2>
                    <p className="research-intro color-tan">
                        During my time at RightOn, I had the opportunity to work with our expert advisors and UX team members to help develop the base of research surrounding the company's core tenants. These tenants include a positive classroom culture of error, a sense of belonging in math spaces, and the power of learning from mistakes. Research was conducted though literature reviews, play testing, and competitive analysis. The following research findings were used to inform the design of RightOn Central.
                    </p>
                    <section className="research-grid">
                        {researchCards.map((card) => (
                            <article key={card.title} className="research-card color-tan" aria-label={`${card.title} Research Card`}>
                                <h3>{card.title}</h3>
                                <p>{card.text}</p>
                            </article>
                        ))}
                ...
                <section id="design-process" className="container-fluid study-section" aria-label="Case Study Design Process">
                    ...
                    <article className="case-study-sect" aria-label="Responsive Design Section">
                        ...
                        <img className="img-fluid" src={rightOnCoverDevices} alt="Screens from the RightOn Central System across different devices" />
                    </article>
                    <article className="case-study-sect" aria-label="Wireframes Section">
                        ...
                        <button type="button" className="btn btn-primary mx-auto d-block color-accent-blue bg-accent-blue color-accent-blue-hover case-study-btn" onClick={() => window.open('https://www.figma.com/design/ICAQP1cDQS9MEnCjlwhKFo/RightOn-Central?node-id=22-67438&t=iLRkIwQlbRt8lS1M-4', '_blank')}>
                            <h3 className="btn-text color-tan">Figma Wireframes</h3>
                        </button>
                        <img className="img-fluid" src={sketches} alt="Early sketched wireframes" />
                        <figure className="d-flex wireframes" aria-label="Early Wireframes of Home and Create Question Screens">
                    ...
                    <article className="case-study-sect" aria-label="High Fidelity Mockups Section">
                        ...
                        <button type="button" className="btn btn-primary mx-auto d-block color-accent-blue bg-accent-blue color-accent-blue-hover case-study-btn" onClick={() => window.open('https://www.figma.com/design/ICAQP1cDQS9MEnCjlwhKFo/RightOn-Central?node-id=0-1&t=xPC0xpj36H08ZDGr-1', '_blank')}>
                            <h3 className="btn-text color-tan">Figma Hi-fi Designs</h3>
                        </button>
                        <img className="img-fluid" src={hifiFlow} alt="Large high fidelity flow of all system screens" />
                    </article>
                ...
                <section id="results" className="container-fluid study-section inverted bg-accent-purple" aria-label="Case Study Results">
                    ...
                    <article className="case-study-sect color-tan" aria-label="Navigation Results Section">
                        ...
                        <figure aria-label="Final Navigation Designs">
                            <figcaption><b>Responsive Navigation</b></figcaption>
                    ...
                    <article className="case-study-sect color-tan" aria-label="Search and Filter Results Section">
                        ...
                        <figure aria-label="Search Bar Figure">
                            <figcaption><b>Search Bar</b></figcaption>
                    ...
                    <article className="case-study-sect color-tan" aria-label="Explore Games, Explore Questions, and My Library Results Section">
                        ...
                        <figure aria-label="Explore Games Figure">
                            <figcaption><b>Explore Games</b></figcaption>
                            <ResponsivePicture src={exploreGames} mobileSrc={exploreGamesMobile} alt="Explore Games Final Desktop, Tablet, and Mobile Designs" />
                        </figure>
                        <figure aria-label="Explore Questions Figure">
                            <figcaption><b>Explore Questions</b></figcaption>
                            <ResponsivePicture src={exploreQuestions} mobileSrc={exploreQuestionsMobile} alt="Explore Questions Final Desktop, Tablet, and Mobile Designs" />
                        </figure>
                        <figure aria-label="My Library Figure">
                            <figcaption><b>My Library</b></figcaption>
                            <ResponsivePicture src={myLibrary} mobileSrc={myLibraryMobile} alt="My Library Final Desktop, Tablet, and Mobile Designs" />
                        </figure>
                    </article>
                    <article className="case-study-sect color-tan" aria-label="View Game and View Questions Results Section">
                        <h3>VIEW GAME &amp; VIEW QUESTION</h3>
                        <p>
                            From any of these explore pages, instructors can click into a game or question to see its details. Viewing a game or question allows you to see the questions, correct answer, incorrect answers, and incorrect answer explanations. This is also where users can launch a game to play with their class.
                        </p>
                        <figure aria-label="View Game Figure">
                            <figcaption><b>View Game</b></figcaption>
                            <ResponsivePicture src={viewGame} mobileSrc={viewGameMobile} alt="View Game Final Desktop, Tablet, and Mobile Designs" />
                        </figure>
                    </article>
                    <article className="case-study-sect color-tan" aria-label="Create Question Results Section">
                        <h3>CREATE QUESTION</h3>
                        <p>
                            One of the most important flows within RightOn Central is the question creation flow. This flow is used to create questions within a game and within the question bank. The user is guided through the flow by secondary-accent highlights around the card next in the process.
                        </p>
                        <ResponsivePicture src={createQuestionFlow} mobileSrc={createQuestionFlowMobile} alt="Create Question Flow Final Designs" />
                        <p>
                            One feature of the RightOn system is the Wrong Answer Explanations Prototype. This program takes in a math question and its multiple-choice options and uses AI to provide possible explanations for the incorrect options. I integrated this functionality directly into the question-creation flow to improve the ease of use.
                        </p>
                        <figure aria-label="Wrong Answer Explanations Integration Figure">
                            <figcaption><b>Wrong Answer Explanations Integration</b></figcaption>
                            <ResponsivePicture src={waePC} mobileSrc={waeMobile} alt="Wrong Answer Explanations Final Designs" />
                        </figure>
                    </article>
                    <article className="case-study-sect color-tan" aria-label="Create Game Results Section">
                        <h3>CREATE GAME</h3>
                        <p>
                            Another important flow is the create game flow. Through this users can create games made of pre-existing questions or pull from the question bank. Users can make both public a private games, but each can only be made of questions of the same type.
                        </p>
                        <figure aria-label="Question Bank Figure">
                            <figcaption><b>Question Bank</b></figcaption>
                            <ResponsivePicture src={questionBankPC} mobileSrc={questionBankMobile} alt="Question Bank Final Desktop, Tablet, and Mobile Designs" />
                        </figure>
                    </article>
                </section>
            </main>
