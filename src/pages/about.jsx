...
const involvementLogos = [
    { href: 'https://www.drexelcab.com/', src: require('../images/about/CAB_FullColor.png'), alt: 'Drexel Campus Activities Board Logo', label: 'Drexel Campus Activities Board Website' },
    { href: 'https://www.instagram.com/drexelchi/?hl=en', src: require('../images/about/drexel-chi-ux.png'), alt: 'Drexel Chi UX Club Logo', label: '@drexelchi on Instagram' },
    { href: 'https://www.instagram.com/drexeldragonfly/', src: require('../images/about/dragonfly-logo.png'), alt: 'Dragonfly Concert 2025 Logo', label: '@drexeldragonfly on Instagram' },
    { href: 'https://rewritingthecode.org/', src: require('../images/about/RTC__Logo_Orange_Logo.png'), alt: 'Rewriting the Code Logo', label: 'Rewriting the Code Website' },
    { href: 'https://ncwit.org/', src: require('../images/about/ncwit.png'), alt: 'National Center for Women and Information Technology Logo', label: 'National Center for Women and Information Technology Website' },
    { href: 'https://girlswhocode.com/', src: require('../images/about/Girls_Who_Code_Logo.png'), alt: 'Girls Who Code Logo', label: 'Girls Who Code Website' }
];

const previousJobs = [
    { href: 'https://www.intealth.org/', src: require('../images/about/logo-intealth.png'), alt: 'Intealth Logo', label: 'Intealth Website', className: 'invert-img2' },
    { href: 'https://www.newcastlede.gov/2423/Libraries', src: require('../images/about/NCC_Libraries.png'), alt: 'New Castle County Libraries Logo', label: 'New Castle County Libraries Website', className: 'invert-img' },
    { href: 'https://www.rightoneducation.com/', src: require('../images/about/RightOn-Circle-512x512.png'), alt: 'RightOn! Education Logo', label: 'RightOn! Education Website', className: '' },
    { href: 'https://www.amazon.com/', src: require('../images/about/Amazon_logo.png'), alt: 'Amazon Logo', label: 'Amazon Website', className: 'invert-img' }
];
        ...
        <main aria-label="About Main Content">
            <section className="row col-sm about" aria-label="About Me Section">
                <article className="col-12 col-md-8 about row justify-content-center" aria-label="About Text Content">
                    ...
                    <p>
                        As a UX/UI Designer and Full Stack Developer I am passionate about creativity, problem-solving, and inclusive design. One of my main goals is to get involved with accessibility in media. I want to promote the consideration of a range of disabilities throughout every step of media creation.
                    </p>
                    <p>
                ...
                <img className="col-12 col-md-4" src={aboutPortrait} alt="Portrait of Olivia Knestaut sitting outside on a rock wall with greenery in the background" />
            </section>
            ...
            <section className="container-fluid col skills" aria-label="Involvement Section">
                ...
                <a href="#recent-activities" className="skip-link about-skip-link color-accent-blue-hover" aria-label="Skip Involvement Links">
                ...
                <div className="d-flex flex-wrap justify-content-center align-items-center bigger-icons">
                    {involvementLogos.slice(0, 3).map((logo) => (
                        <a key={logo.label} href={logo.href} target="_blank" rel="noopener noreferrer" aria-label={`${logo.label} — opens in a new tab`}>
            ...
            <section id="recent-activities" className="container-fluid col" aria-label="Recent Activities Section">
                ...
                <a href="#previous-jobs" className="skip-link about-skip-link color-accent-blue-hover" aria-label="Skip Recent Activities Photo Gallery">
            ...
            <section id="previous-jobs" className="container-fluid col skills" aria-label="Previous Jobs Section">
                ...
                <a href="#contact" className="skip-link about-skip-link color-accent-blue-hover" aria-label="Skip Previous Jobs Links">
                    Skip Previous Jobs Links
                </a>
                <div className="d-flex flex-wrap justify-content-center align-items-center bigger-icons">
                    {previousJobs.map((job) => (
                        <a key={job.label} href={job.href} target="_blank" rel="noopener noreferrer" aria-label={`${job.label} — opens in a new tab`}>
            ...
            <section id="contact" className="contact" aria-label="Contact Section">
                ...
                <div className="row col-sm">
                    <img className="col-12 col-md-7" src={aboutContact} alt="Olivia looking up at a huge tree while hiking in Mount Rainier National Park, WA" />
                    <article className="col-12 col-md-5 row d-flex justify-content-around align-items-center contact-info" aria-label="Contact Information">
                        ...
                        <figure aria-label="Contact Links">
                            <a href="#footer" className="skip-link contact-skip-link color-accent-blue-hover" aria-label="Skip Contact Links">
                                Skip Contact Links
                            </a>
                            <a href="https://www.instagram.com/ollywhelmed/" target="_blank" rel="noopener noreferrer" aria-label="@ollywhelmed on Instagram — opens in a new tab">
                            ...
                            <a href="https://github.com/OliviaKnestaut" target="_blank" rel="noopener noreferrer" aria-label="OliviaKnestaut on GitHub — opens in a new tab">
                                <img className="contact-icon" src={githubIcon} alt="github icon" />
                            </a>
                            <a href="https://www.linkedin.com/in/oliviaknestaut/" target="_blank" rel="noopener noreferrer" aria-label="Olivia Knestaut on LinkedIn — opens in a new tab">
